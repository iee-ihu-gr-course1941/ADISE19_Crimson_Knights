...
#### Μηδενισμός & αρχικοποίηση πινάκων

```
GET /reset_board/
```

Μηδενίζει τους πίνακες HANDS και TURNS και αρχικοποιεί ξανά τον πίνακα BOARD.
...
```
GET /get_initial_board_state/
```

Με δεδομένο των αριθμό των παικτών και την κατάσταση του παιχνιδιού, καλεί την setup_board η οποία θέτει ενεργό 
το παιχνίδι.
